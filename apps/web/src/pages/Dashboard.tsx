  ...
  return (
    <div className="p-6">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
        <Link to="/patients/register" className="bg-white p-6 rounded-lg shadow hover:shadow-lg">
          <h3 className="font-bold text-lg">Patient Registration</h3>
          <p className="text-gray-600">Register new patient</p>
        </Link>

        <Link to="/appointments/book" className="bg-white p-6 rounded-lg shadow hover:shadow-lg">
          <h3 className="font-bold text-lg">Book Appointment</h3>
          <p className="text-gray-600">Schedule patient visit</p>
        </Link>

        <Link to="/consultation" className="bg-white p-6 rounded-lg shadow hover:shadow-lg">
